...
#+SUBTITLE: [[https://www.github.com/dominikpegler/internship_ml][code repo]] -- [[https://meet.jit.si/UnexpectedMachineLearningAlgorithmsLeftNoDoubt][jitsi room]]
...
#+EXPORT_FILE_NAME: ~/Dropbox/org/internship_ml_page/index.html
#+html: <center>
...
** TODO 2. Meeting mit David
SCHEDULED: <2022-03-08 Tue 10:00>
*** Themen
     1. Fortschritt beim Script
     2. Besprechen der Regressoren und Hyperparameter
     3. Möglichkeit Mitschauen via zoom bei TEWA1?
     4. Besprechen von anderem möglichen Projekt zu Computer vision
