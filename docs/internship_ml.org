...
#+end_src
   ...
   #+begin_example
   Split 1
   best model: Ridge(alpha=175)
   score on train data: 0.4135031705261416
   score on  test data: 0.34184279369583503


   Split 2
   best model: Ridge(alpha=325)
   score on train data: 0.3750219749088204
   score on  test data: 0.3314578657437346


   Split 3
   best model: Ridge(alpha=225)
   score on train data: 0.40876226512662284
   score on  test data: 0.32626281745262575


   Split 4
   best model: Ridge(alpha=225)
   score on train data: 0.402936433716616
   score on  test data: 0.34148479321013503


   Split 5
   best model: Ridge(alpha=175)
   score on train data: 0.4490062411714646
   score on  test data: 0.22463502011492265
