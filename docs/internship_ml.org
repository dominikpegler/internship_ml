...
def main():
    ...
    hyperparams_grid = {"alpha": [0.1, 0.5, 1, 10, 50, 100, 150, 175, 200, 225,
                                  250, 275, 300, 325, 350, 375, 400, 450, 500, 700,
                                  1000],
...
#+end_src
   ...
   #+begin_example
   Split 1
   best model: ElasticNet(alpha=0.1, l1_ratio=0.6)
   score on train data: 0.6408830871487755
   score on  test data: 0.6296417794620053


   Split 2
   best model: ElasticNet(alpha=0.1, l1_ratio=0.6)
   score on train data: 0.6421658304122375
   score on  test data: 0.6244548003243462


   Split 3
   best model: ElasticNet(alpha=0.1)
   score on train data: 0.6336695795675005
   score on  test data: 0.6474037756037557


   Split 4
   best model: ElasticNet(alpha=0.1, l1_ratio=0.7)
   score on train data: 0.6367876011324975
   score on  test data: 0.6580576873961166
