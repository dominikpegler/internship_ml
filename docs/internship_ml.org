...
#+end_src
   ...
   #+begin_example
   Split 1
   best model: ElasticNet(alpha=50, l1_ratio=0.9)
   score on train data: 0.18441269202736688
   score on  test data: 0.17918716797658552


   Split 2
   best model: ElasticNet(alpha=1, l1_ratio=0.2)
   score on train data: 0.4851575981391737
   score on  test data: 0.4738602553394592


   Split 3
   best model: ElasticNet(alpha=10, l1_ratio=0.9)
   score on train data: 0.44619914967408625
   score on  test data: 0.4488238150912305


   Split 4
   best model: ElasticNet(alpha=1)
   score on train data: 0.5350036161890235
   score on  test data: 0.5514294212291815


   Split 5
   best model: ElasticNet(alpha=175, l1_ratio=0.9)
   score on train data: 0.0628506366743743
   score on  test data: 0.06228349013990775


   Execution time: 2.600s
   #+end_example
